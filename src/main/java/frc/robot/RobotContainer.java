...
public class RobotContainer
{
    ...
    private void configureButtonBindings(Indexer indexer)
    {
        ...
        new JoystickButton(gamepad, Button.kY.value)
            .whileTrue(new RunIndexerUpper(indexer, DashboardConstants.indexerUpperInPercentageKey));
    ...
    private void configureButtonBindings(Intake intake)
    {
        ...
        new JoystickButton(gamepad, Button.kA.value)
            .whileTrue(new RunIntake(intake, DashboardConstants.intakeInPercentageKey));
        new JoystickButton(gamepad, Button.kX.value)
            .whileTrue(new RunIntake(intake, DashboardConstants.intakeOutPercentageKey));

        new JoystickButton(gamepad, Button.kLeftStick.value)
            .onTrue(new InstantCommand(() -> intake.extend(), intake));
        new JoystickButton(gamepad, Button.kRightStick.value)
            .onTrue(new InstantCommand(() -> intake.retract(), intake));
    }
    ...
    private void configureButtonBindings(Climber climber)
    {
        ...
        // opposite directions at the same time.
        extendHooks.whileTrue(
            new MoveClimberHooks(climber, DashboardConstants.climberHooksExtendSpeedKey)
            .until(retractHooks::getAsBoolean));
        retractHooks.whileTrue(
            new MoveClimberHooks(climber, DashboardConstants.climberHooksRetractSpeedKey)
            .until(extendHooks::getAsBoolean));

        new JoystickButton(leftStick, 3)
            .onTrue(new InstantCommand(() -> climber.moveClimberUp(), climber));
        new JoystickButton(leftStick, 4)
            .onTrue(new InstantCommand(() -> climber.moveClimberDown(), climber));
    }
